...
const modelTemplateString = `// Code generated by go-uaa/generator; DO NOT EDIT.
...
func (a *API) Update{{.ModelTypeName}}({{tolower .ModelTypeName}} {{.ModelTypeName}}) (*{{.ModelTypeName}}, error) {
	u := urlWithPath(*a.TargetURL, fmt.Sprintf("%s/%s", {{.ModelPluralTypeName}}Endpoint, {{tolower .ModelTypeName}}.UpdateID()))
